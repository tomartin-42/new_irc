...
# define RPL_WELCOME(nick) (nick + " :Welcome to the Internet Relay Network " + nick + "\r\n")
...
# define RPL_WHOISSERVER(pseudo, server, info) (pseudo + " " + server + " :" + info + "\r\n")
...
# define RPL_TIME(server, time_server) (server + " :" + time_server + "\r\n")
