...
/*   Updated: 2022/12/24 15:05:11 by tomartin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	load.msg_out.add_msg(load.msg_out.fragmentation_msg_send(generator.wallops_needmoreparams(demo), generator.get_head_len()));
